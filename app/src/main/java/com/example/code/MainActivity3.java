    ...
    private void postData(String name, String gender, String age, String medicalHistory) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                // 请求失败时运行
                runOnUiThread(() -> Toast.makeText(MainActivity3.this, "请求失败: " + e.getMessage(), Toast.LENGTH_SHORT).show());
            }
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(MainActivity3.this, "注册完成", Toast.LENGTH_LONG).show();
                    ...
                    runOnUiThread(() -> Toast.makeText(MainActivity3.this, "注册失败", Toast.LENGTH_SHORT).show());
                }
            }
        });
    }
