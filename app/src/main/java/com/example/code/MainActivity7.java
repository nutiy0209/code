...
public class MainActivity7 extends AppCompatActivity {
    ...
    private void callFlaskApi(String query) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://192.168.245.8:5000/") // 替換為 Flask 服务器的局域网 IP
        ...
        QueryRequest2 request = new QueryRequest2(query, selectedMainCategory, selectedSubCategory);
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    if (apiResponse != null) {
                        ...
                        Toast.makeText(MainActivity7.this, "收到響應", Toast.LENGTH_SHORT).show();
